...
namespace ProyectoLibreria.Controllers
{
    public class tipoUsuariosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id_tipoUsuario,nombre_tipoUsuario,activo")] tipoUsuario tipoUsuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id_tipoUsuario,nombre_tipoUsuario,activo")] tipoUsuario tipoUsuario)
        {
            if (ModelState.IsValid)
            {
