...
namespace ProyectoLibreria.Controllers
{
    public class GeneroesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id_genero,nombre_genero,descripcion_genero,activo")] Genero genero)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id_genero,nombre_genero,descripcion_genero,activo")] Genero genero)
        {
            if (ModelState.IsValid)
            {
